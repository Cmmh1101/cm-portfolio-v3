      ...
      <Container id="about">
        <Row>
          <Col xs={12} className="my-5 projects-section">
            ...
            >
              <Col xs={12} lg={6}>
                <AnimationOnScroll animateIn="animate__fadeInUp animate__delay-1s pr-5" animateOnce>
                  {englishMode
              ...
              <Col xs={8} lg={6} className="px-5 my-5 my-lg-0">
                <AnimationOnScroll animateIn="animate__fadeInUp animate__delay-1s" animateOnce>
                  <img
